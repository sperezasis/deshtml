...
- [ ] **Phase 1: Foundation — Installer + Design Assets** - Atomic curl-pipe-bash installer and verbatim Caseproof design fragments ready for Claude to paste
...
|-------|----------------|--------|-----------|
| 1. Foundation — Installer + Design Assets | 0/TBD | Not started | - |
